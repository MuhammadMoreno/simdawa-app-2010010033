        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Perbaharui Data PersyaratanBeasiswa </h2>
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?= base_url('home') ?>" class="breadcrumb-link">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="<?= base_url('persyaratan') ?>" class="breadcrumb-link">Syarat Beasiswa</a></li>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header">
                        Perbaharui Data Syarat Beasiswa
                    </div>
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group row">
                                <input type="hidden" name="id" value="<?= $persyaratan->id ?>">
                                <label for="nama_persyaratan" class="col-md-2">Nama Syarat Beasiswa</label>
                                <div class="col-md-10">
                                    <input type="text" name="nama_persyaratan" required placeholder="Nama Syarat Beasiswa" value="<?= $persyaratan->nama_persyaratan ?>" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
